...
def find_model(model_name):
    ...
    if model_name in pretrained_models:  
        ...
        assert os.path.exists(model_name), f'Could not find SiT checkpoint at {model_name}'
...
def is_url(obj, allow_file_urls: bool = False) -> bool:
...
def open_url(url: str, cache_dir: str | None = None, num_attempts: int = 10, verbose: bool = True, return_filename: bool = False, cache: bool = True):
